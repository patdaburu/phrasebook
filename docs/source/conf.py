...
# -*- coding: utf-8 -*-
#
# phrasebook documentation build configuration file
#
...
version = phrasebook.__version__
# The full version, including alpha/beta/rc tags.
release = phrasebook.__release__
...
htmlhelp_basename = 'phrasebookdoc'
...
latex_documents = [
    (master_doc, 'phrasebook.tex', 'phrasebook Documentation',
     'patdaburu', 'manual'),
]
...
man_pages = [
    (master_doc, 'phrasebook', 'phrasebook Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'phrasebook', 'phrasebook Documentation',
     author, 'phrasebook', 'One line description of project.',
     'Miscellaneous'),
]
